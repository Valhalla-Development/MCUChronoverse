...
export const curatedChronology: readonly CuratedTimelineEntry[] = [
    ...
    },
    {
        ...
        note: "Shared Fox history before the 1973 divergence. Both the original Earth-41578 history and revised Earth-10005 history inherit these events. The Earth numbers follow the later Appendix distinction.",
        placement: "1962",
    ...
    },
    {
        ...
        note: "Timeline junction: Wolverine travels from the original Earth-41578 future in 2023 to 1973, creating the revised Earth-10005 history. Chronological order uses the 1973 story; the film also depicts both futures. Earth numbers follow the later Appendix distinction.",
    ...
    },
    {
        ...
        note: "Earth-10005 future set in 2029, after the contemporary events of Deadpool & Wolverine. Choose release order to see Logan before the Deadpool films reveal its ending.",
        placement: "2029",
